...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.df = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/mnist/arr/mask_12_07_f.npy').astype(float)).type(torch.FloatTensor).cuda())
        ...
        self.d4 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/mnist/arr/mask_12_07_4.npy').astype(float)).type(torch.FloatTensor).cuda())
        ...
        self.d8 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/mnist/arr/mask_12_07_8.npy').astype(float)).type(torch.FloatTensor).cuda())
