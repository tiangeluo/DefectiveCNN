...
class DenseNet(nn.Module):
    def __init__(self, block, nblocks, growth_rate=12, reduction=0.5, num_classes=10):
        ...
        self.d0 = drop(torch.from_numpy(np.load( '/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_0.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d1 = drop(torch.from_numpy(np.load( '/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_1.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d2 = drop(torch.from_numpy(np.load( '/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_2.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d3 = drop(torch.from_numpy(np.load( '/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_3.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d4 = drop(torch.from_numpy(np.load( '/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_4.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d5 = drop(torch.from_numpy(np.load( '/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_5.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d6 = drop(torch.from_numpy(np.load( '/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_6.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d7 = drop(torch.from_numpy(np.load( '/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_7.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d8 = drop(torch.from_numpy(np.load( '/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_8.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d9 = drop(torch.from_numpy(np.load( '/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_9.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d10 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_10.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d11 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_11.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d12 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_12.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d13 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_13.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d14 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_14.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d15 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_15.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d16 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_16.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d17 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_17.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d18 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_18.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d19 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/mnist/arr/mask_dense_12_05_19.npy').astype(float)).type(torch.FloatTensor).cuda())
