...
class VGG(nn.Module):
    def __init__(self, vgg_name):
        ...
        self.d0 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/arr/mask_vgg_012_07_0.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d1 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/arr/mask_vgg_012_07_1.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d2 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/arr/mask_vgg_012_07_2.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d3 = drop(torch.from_numpy(np.load('/home/luotg/Projects/Adversarial/arr/mask_vgg_012_07_3.npy').astype(float)).type(torch.FloatTensor).cuda())
