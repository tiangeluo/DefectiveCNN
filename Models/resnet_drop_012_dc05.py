...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.conv11 = nn.Conv2d(32, 32, kernel_size=3, stride=1, padding=1, bias=False)
        self.conv12 = nn.Conv2d(32, 32, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.shortcut11 = nn.Sequential(nn.Conv2d(32, 32, kernel_size=1, bias=False),
                          nn.BatchNorm2d(32))
        ...
        self.conv41 = nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1, bias=False)
        self.conv42 = nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn31 = nn.BatchNorm2d(64)
        self.bn32 = nn.BatchNorm2d(64)
        self.bn41 = nn.BatchNorm2d(64)
        self.bn42 = nn.BatchNorm2d(64)
        self.shortcut21 = nn.Sequential(nn.Conv2d(32, 64, kernel_size=1, stride=2, bias=False),
                          nn.BatchNorm2d(64))
