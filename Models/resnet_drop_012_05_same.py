...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.df = drop(torch.from_numpy(np.load('arr/mask_12_05_same_f.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d0 = drop(torch.from_numpy(np.load('arr/mask_12_05_same_0.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d1 = drop(torch.from_numpy(np.load('arr/mask_12_05_same_1.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d2 = drop(torch.from_numpy(np.load('arr/mask_12_05_same_2.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d3 = drop(torch.from_numpy(np.load('arr/mask_12_05_same_3.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d4 = drop(torch.from_numpy(np.load('arr/mask_12_05_same_4.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d5 = drop(torch.from_numpy(np.load('arr/mask_12_05_same_5.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d6 = drop(torch.from_numpy(np.load('arr/mask_12_05_same_6.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d7 = drop(torch.from_numpy(np.load('arr/mask_12_05_same_7.npy').astype(float)).type(torch.FloatTensor).cuda())
        self.d8 = drop(torch.from_numpy(np.load('arr/mask_12_05_same_8.npy').astype(float)).type(torch.FloatTensor).cuda())
