...
mask0 = np.ones([256,8,8])
mask1 = np.ones([256,8,8])
mask2 = np.ones([256,8,8])
mask3 = np.ones([256,8,8])
mask4 = np.ones([256,8,8])
mask5 = np.ones([512,4,4])
mask6 = np.ones([512,4,4])
mask7 = np.ones([512,4,4])
mask8 = np.ones([512,4,4])
mask9 = np.ones([512,4,4])

mask0.reshape(-1)[random.sample(range(np.prod(mask0.shape)), (np.sum(mask0)*0.3).astype(int))]=0
mask1.reshape(-1)[random.sample(range(np.prod(mask1.shape)), (np.sum(mask1)*0.3).astype(int))]=0
mask2.reshape(-1)[random.sample(range(np.prod(mask2.shape)), (np.sum(mask2)*0.3).astype(int))]=0
mask3.reshape(-1)[random.sample(range(np.prod(mask3.shape)), (np.sum(mask3)*0.3).astype(int))]=0
mask4.reshape(-1)[random.sample(range(np.prod(mask4.shape)), (np.sum(mask4)*0.3).astype(int))]=0
mask5.reshape(-1)[random.sample(range(np.prod(mask5.shape)), (np.sum(mask5)*0.3).astype(int))]=0
mask6.reshape(-1)[random.sample(range(np.prod(mask6.shape)), (np.sum(mask6)*0.3).astype(int))]=0
mask7.reshape(-1)[random.sample(range(np.prod(mask7.shape)), (np.sum(mask7)*0.3).astype(int))]=0
mask8.reshape(-1)[random.sample(range(np.prod(mask8.shape)), (np.sum(mask8)*0.3).astype(int))]=0
mask9.reshape(-1)[random.sample(range(np.prod(mask9.shape)), (np.sum(mask9)*0.3).astype(int))]=0
...
print('mask num', np.sum(1-mask9), 'total num', np.prod(mask9.shape))
np.save('./arr/mask_34_03_0.npy', mask0)
np.save('./arr/mask_34_03_1.npy', mask1)
np.save('./arr/mask_34_03_2.npy', mask2)
np.save('./arr/mask_34_03_3.npy', mask3)
np.save('./arr/mask_34_03_4.npy', mask4)
np.save('./arr/mask_34_03_5.npy', mask5)
np.save('./arr/mask_34_03_6.npy', mask6)
np.save('./arr/mask_34_03_7.npy', mask7)
np.save('./arr/mask_34_03_8.npy', mask8)
np.save('./arr/mask_34_03_9.npy', mask9)
