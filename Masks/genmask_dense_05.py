...
mask1 = np.ones([96,32,32])
mask2 = np.ones([128,32,32])
mask3 = np.ones([160,32,32])
mask4 = np.ones([192,32,32])
mask5 = np.ones([224,32,32])
mask6 = np.ones([256,32,32])
mask7 = np.ones([128,16,16])
mask8 = np.ones([160,16,16])
mask9 = np.ones([192,16,16])
mask10 = np.ones([224,16,16])
mask11 = np.ones([256,16,16])
mask12 = np.ones([288,16,16])
mask13 = np.ones([320,16,16])
mask14 = np.ones([352,16,16])
mask15 = np.ones([384,16,16])
mask16 = np.ones([416,16,16])
mask17 = np.ones([448,16,16])
mask18 = np.ones([480,16,16])
mask19 = np.ones([512,16,16])
...
mask9.reshape(-1)[random.sample(range(np.prod(mask9.shape)), (np.sum(mask9)*0.5).astype(int))]=0
mask10.reshape(-1)[random.sample(range(np.prod(mask10.shape)), (np.sum(mask10)*0.5).astype(int))]=0
mask11.reshape(-1)[random.sample(range(np.prod(mask11.shape)), (np.sum(mask11)*0.5).astype(int))]=0
mask12.reshape(-1)[random.sample(range(np.prod(mask12.shape)), (np.sum(mask12)*0.5).astype(int))]=0
mask13.reshape(-1)[random.sample(range(np.prod(mask13.shape)), (np.sum(mask13)*0.5).astype(int))]=0
mask14.reshape(-1)[random.sample(range(np.prod(mask14.shape)), (np.sum(mask14)*0.5).astype(int))]=0
mask15.reshape(-1)[random.sample(range(np.prod(mask15.shape)), (np.sum(mask15)*0.5).astype(int))]=0
mask16.reshape(-1)[random.sample(range(np.prod(mask16.shape)), (np.sum(mask16)*0.5).astype(int))]=0
mask17.reshape(-1)[random.sample(range(np.prod(mask17.shape)), (np.sum(mask17)*0.5).astype(int))]=0
mask18.reshape(-1)[random.sample(range(np.prod(mask18.shape)), (np.sum(mask18)*0.5).astype(int))]=0
mask19.reshape(-1)[random.sample(range(np.prod(mask19.shape)), (np.sum(mask19)*0.5).astype(int))]=0
...
np.save('./arr/mask_dense_12_05_0.npy', mask0)
np.save('./arr/mask_dense_12_05_1.npy', mask1)
np.save('./arr/mask_dense_12_05_2.npy', mask2)
np.save('./arr/mask_dense_12_05_3.npy', mask3)
np.save('./arr/mask_dense_12_05_4.npy', mask4)
np.save('./arr/mask_dense_12_05_5.npy', mask5)
np.save('./arr/mask_dense_12_05_6.npy', mask6)
np.save('./arr/mask_dense_12_05_7.npy', mask7)
np.save('./arr/mask_dense_12_05_8.npy', mask8)
np.save('./arr/mask_dense_12_05_9.npy', mask9)
np.save('./arr/mask_dense_12_05_10.npy', mask10)
np.save('./arr/mask_dense_12_05_11.npy', mask11)
np.save('./arr/mask_dense_12_05_12.npy', mask12)
np.save('./arr/mask_dense_12_05_13.npy', mask13)
np.save('./arr/mask_dense_12_05_14.npy', mask14)
np.save('./arr/mask_dense_12_05_15.npy', mask15)
np.save('./arr/mask_dense_12_05_16.npy', mask16)
np.save('./arr/mask_dense_12_05_17.npy', mask17)
np.save('./arr/mask_dense_12_05_18.npy', mask18)
np.save('./arr/mask_dense_12_05_19.npy', mask19)
