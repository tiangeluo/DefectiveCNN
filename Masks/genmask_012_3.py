...
maskf.reshape(-1)[random.sample(range(np.prod(maskf.shape)), (np.sum(maskf)*0.3).astype(int))]=0
...
np.save('./arr/mask_12_03_f.npy', maskf)
np.save('./arr/mask_12_03_0.npy', mask0)
np.save('./arr/mask_12_03_1.npy', mask1)
np.save('./arr/mask_12_03_2.npy', mask2)
np.save('./arr/mask_12_03_3.npy', mask3)
np.save('./arr/mask_12_03_4.npy', mask4)
np.save('./arr/mask_12_03_5.npy', mask5)
np.save('./arr/mask_12_03_6.npy', mask6)
np.save('./arr/mask_12_03_7.npy', mask7)
np.save('./arr/mask_12_03_8.npy', mask8)
